...
class Enemy(pygame.sprite.Sprite):
    ...
    def draw(self, surface, camera_offset_x):
        ...
        if self.enemy_type == "ground":
            # ── Goomba-style brown mushroom creature ──────────────
            # Feet
            ...
            # ── Koopa-style flying shell creature ─────────────────
            # Wings
            pygame.draw.polygon(surface, (255,255,200), [
                (rx-18, ry+h//2), (rx-2, ry+3), (rx+8, ry+h//2)])
            pygame.draw.polygon(surface, (255,255,200), [
                (rx+w+18, ry+h//2), (rx+w+2, ry+3), (rx+w-8, ry+h//2)])
            pygame.draw.polygon(surface, (200,200,140), [
                (rx-18, ry+h//2), (rx-2, ry+3), (rx+8, ry+h//2)], 1)
            pygame.draw.polygon(surface, (200,200,140), [
                (rx+w+18, ry+h//2), (rx+w+2, ry+3), (rx+w-8, ry+h//2)], 1)
            # Shell body
        ...
        # State badge
        badge_colors = {"patrol":(120,120,120),"chase":(220,50,50),
                        "ambush":(200,100,0),"retreat":(50,100,200),"block":(100,50,200)}
        bcol = badge_colors.get(self.state, (100,100,100))
        font = pygame.font.SysFont("Arial", 11, bold=True)
        lbl  = font.render(self.state[:3].upper(), True, (255,255,255))
