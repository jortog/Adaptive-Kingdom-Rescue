...
class Level01(LevelBase):
    ...
    def get_enemy_spawns(self):
        ...
        gy   = (rows - 2) * TILE_SIZE
        return [
            {"x": 8  * TILE_SIZE, "y": gy, "type": "ground",
             "patrol_left": 6 * TILE_SIZE,  "patrol_right": 12 * TILE_SIZE},
            {"x": 14 * TILE_SIZE, "y": gy, "type": "flophopper",
             "patrol_left": 13 * TILE_SIZE, "patrol_right": 17 * TILE_SIZE},
            {"x": 20 * TILE_SIZE, "y": gy, "type": "ground",
             "patrol_left": 18 * TILE_SIZE, "patrol_right": 24 * TILE_SIZE},
            {"x": 26 * TILE_SIZE, "y": gy - 3*TILE_SIZE, "type": "flying",
             "patrol_left": 23 * TILE_SIZE, "patrol_right": 30 * TILE_SIZE},
            {"x": 30 * TILE_SIZE, "y": gy, "type": "ground",
             "patrol_left": 28 * TILE_SIZE, "patrol_right": 33 * TILE_SIZE},
        ]
