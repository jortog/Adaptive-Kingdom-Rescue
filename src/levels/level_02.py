...
class Level02(LevelBase):
    ...
    def get_enemy_spawns(self):
        ...
        return [
            {"x": 8*TILE_SIZE,  "y": ground_y, "type": "ground",
             "patrol_left": 5*TILE_SIZE,  "patrol_right": 12*TILE_SIZE},
            {"x": 16*TILE_SIZE, "y": ground_y, "type": "flying",
             "patrol_left": 13*TILE_SIZE, "patrol_right": 20*TILE_SIZE},
            {"x": 22*TILE_SIZE, "y": ground_y, "type": "ground",
             "patrol_left": 19*TILE_SIZE, "patrol_right": 26*TILE_SIZE},
            {"x": 26*TILE_SIZE, "y": ground_y, "type": "flying",
